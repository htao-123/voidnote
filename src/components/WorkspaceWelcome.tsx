    ...
    <div className="flex items-center justify-center h-screen bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800">
      <div className="text-center space-y-8 p-12">
        ...
        <div className="space-y-3">
          <h1 className="text-4xl font-bold text-gray-900 dark:text-gray-100">欢迎使用 VoidNote</h1>
          <p className="text-lg text-gray-600 dark:text-gray-400">选择一个文件夹作为知识库存储位置</p>
        </div>

        {/* 说明 */}
        <div className="max-w-md mx-auto text-left bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700">
          <h3 className="font-medium text-gray-900 dark:text-gray-100 mb-3">知识库功能</h3>
